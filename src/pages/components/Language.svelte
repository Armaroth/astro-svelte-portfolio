  ...
  {#if lang === "en"}
    <svg
      ...
      ></path><rect x="13" y="4" width="6" height="24" fill="#fff"></rect><rect
        ...
        height="6"
        fill="#fff"
      ></rect><rect x="14" y="4" width="4" height="24" fill="#b92932"
      ></rect><rect
        x="14"
        y="1"
        width="4"
  ...
  {:else}
    <svg
      ...
      ></rect><path
        ...
        fill="#295cab"
      ></path><path fill="#295cab" d="M1 9.34H31V12.01H1z"></path><path
        fill="#295cab"
        d="M1 14.68H31V17.35H1z"
      ></path><path fill="#295cab" d="M1 20.02H31V22.689999999999998H1z"
      ></path><path
      ...
      ></path><path
        ...
        fill="#295cab"
      ></path><path fill="#fff" d="M1 9.34H14.35V12.01H1z"></path><path
